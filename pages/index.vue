  ...
  meta: [
    {
      name: "description",
      content:
        "Easetrail, is local search engine, provides Best Deals, Shop Online, Ticket Booking for Flights, Hotels, Movies, Buses and Cabs. You can also Order Food, Book Restaurant Table, View Menu, Book Doctors’ Appointments. Justdial curates Social content, News, Videos and more from Top Publishers on all Trending Topics.",
    },
  ],
});
